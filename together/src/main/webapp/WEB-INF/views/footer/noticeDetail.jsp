...
<script>
	$(document).ready(function(){
		$('#noticeBoard').click(function(){
			location.href="${ pageContext.request.contextPath }/board/noticeBoard";
		});
	});
						...
						<div class="blog-entry ftco-animate accompanyWrite">
							...
							<div class="board_all_div">
								...
								<div class="board_list">
									<table class="notice_de">
										<tr>
											<th>채식게시판 양식변경안내</th>
											<th width="20%">2018-12-19</th>
										</tr>
										<tr>
											<td colspan="2">채식게시판 양식은 아래와 같이 변경되었습니다</td>
										</tr>
									</table>
									<button id="noticeBoard" class="notice_btn">목록</button>
