...
<body>
				...
				<div class="container">
					...
					<div class="row">
						<div class="blog-entry ftco-animate accompanyWrite">
							<form name="travelPlanForm" action="${pageContext.request.contextPath}/matching/accompanyAfterUpdateUp/${afterdt.no}"
								enctype="multipart/form-data" method="post">
								<input type="hidden" name="writer" value="${userVO.name}">
			    				<input type="hidden" name="email" value="${userVO.email }">
								<div class="form-travelSpot-top"></div>
	...
	<%-- 									<dl>
											<dt class="form-travelSpot">Writer</dt>
											<dd class="form-travelSpot">
												<input type="text" class="accompanyWrite" size="10"
													name="writer" value="${afterdt.writer}">
											</dd>
										</dl> --%>
										<dl>
											<dt class="form-travelSpot"></dt>
											<dd class="form-travelSpot"></dd>
										</dl>
										...
										<dl>
											...
											<dd class="form-travelSpot">
												<input type="text" class="accompanyWrite" size="10" 
													name="title" value="${afterdt.title}">
											</dd>
										</dl>
										<div class="datePakage">Content</div>
										<div class="form-travelSpot">
											<textarea rows="12" cols="30" class="accompanyWrite"
												name="content">${afterdt.content}</textarea>
										</div>
									</div>
									...
									<div>
										...
										<input
											type="submit" value="Submit" style="float: right"
											class="btn btn-primary py-3 px-5" class="accompanyWriteBtn">
										<input type="button" style="float:right;margin-right: 10px;" value="cancel"
											class="btn btn-primary py-3 px-5" class="accompanyWriteBtn" onclick="window.location.href='${pageContext.request.contextPath}/matching/accompanyAfter'">
									</div>
								</div>
							</form>
						</div>
