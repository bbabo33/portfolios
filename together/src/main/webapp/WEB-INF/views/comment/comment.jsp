...
<c:forEach items="${colist}" var="board">
	<div style="background-color: #ffffff;">
		<table style="width: 100%;">
			<tr>
				...
				<th width="40%"><span style="float: right">
	...
	<div class="collapse" id="${board.no}">
		<table style="margin-top: 8px;">
			<tr>
				<td width="3%"><span style="font-size: 22px; color: #888888">┖</span><br>
				<br></td>
				<td width="90%"><textarea class="form-control"
						id="co${board.no}" rows="2" cols="170" name="content" id="comment"></textarea>
				</td>
				<td width="7%"><input class="btn"
					style="font-size: large; background-color: #B9826E; color: #ffffff; float: right; margin-top: 8px;"
					type="button" id="commentbtn" value="등록"
					onclick="ajaxjs(${board.no});">&nbsp;&nbsp;
					</div>
					<br>
				<br></td>
			</tr>
